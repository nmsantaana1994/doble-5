  ...
  <section class="p-3">
    ...
    <div class="row">
      <form action="#" method="get" @submit="handleSubmit">
        ...
        <div class="mb-3">
          <select id="complejo" class="form-select" name="complejo" v-model="fields.complejo">
        ...
        <div class="mb-3">
          <select id="cantidadJ" name="cantidadJ" class="form-select" v-model="fields.cantidadJ">
        ...
        <div class="mb-3">
          <select id="cambios" name="cambios" class="form-select" v-model="fields.cambios">
        ...
        <div class="mb-3">
          <select id="tipo" name="tipo" class="form-select" v-model="fields.tipo">
