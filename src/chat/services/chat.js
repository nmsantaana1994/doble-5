...
import { getPrivateChatRef } from "./private-chats";
/**
...
export function sendMessage(data) {
  ...
  return addDoc(chatRef, {
    ...
    .catch((err) => {
      console.error(
        "[chat.js sendMessage] Ocurrió un error al enviar el mensaje.",
        err
      );
      throw err;
    });
...
// export async function getMessagesByChat(user1,user2){
// const chatRef = await getPrivateChatRef(user1,user2);
